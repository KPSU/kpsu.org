...
Gem::Specification.new do |s|
  ...
  s.files = [".gemtest", ".rspec", ".yardopts", "LICENSE", "Rakefile", "autotest/discover.rb", "lib/oa-core.rb", "lib/omniauth/builder.rb", "lib/omniauth/core.rb", "lib/omniauth/form.rb", "lib/omniauth/strategy.rb", "lib/omniauth/test.rb", "lib/omniauth/test/phony_session.rb", "lib/omniauth/test/strategy_macros.rb", "lib/omniauth/test/strategy_test_case.rb", "lib/omniauth/version.rb", "oa-core.gemspec", "spec/omniauth/builder_spec.rb", "spec/omniauth/core_spec.rb", "spec/omniauth/strategy_spec.rb", "spec/spec_helper.rb"]
