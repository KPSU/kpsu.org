...
Gem::Specification.new do |s|
  ...
  s.files = [".gemtest", ".rspec", ".yardopts", "LICENSE", "README.rdoc", "Rakefile", "lib/oa-basic.rb", "lib/omniauth/basic.rb", "lib/omniauth/strategies/http_basic.rb", "lib/omniauth/version.rb", "oa-basic.gemspec", "spec/omniauth/strategies/basic_spec.rb", "spec/spec_helper.rb"]
