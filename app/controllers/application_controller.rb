...
class ApplicationController < ActionController::Base
  ...
  def kpsu_twitter_token
    "161043625-TxvxqYwBytqXUUl39OsSG69nKWE627ytO5eD9yGA"
  end
  
  def kpsu_twitter_secret
    "cUJcwjodXgwwdIO6GU7Urjd9UnfZb1nJBr6ojR8NWEw"
  end
  
  def twitter_consumer_secret
    "q2yX19uuy2izSHKKcunNEMjk1BCGjnEeRg0JCCMF18"
  end
  
  def twitter_consumer_key
    "GRpxk6zjTKk3o7wTuXiSw"
  end
