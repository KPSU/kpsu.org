...
(function($, undefined) {
  ...
  $.rails = rails = {
    ...
    handleRemote: function(element) {
      ...
      var patPosts = "posts"
			if ((url.match(/\d$/) && url.match(patUsers)) || (url.match(/\d$/) && url.match(patPosts)) || (url.match(/\d$/) && url.match(patPrograms)) || (url.match(/\d$/) && url.match(patVolunteers)) || (url.match(patNewPlaylists)) ){
